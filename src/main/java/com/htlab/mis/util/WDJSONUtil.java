 ...
 * @author John Tang
 */
public class WDJSONUtil {
	
	public static String format(BigDecimal num) {
        NumberFormat nf = NumberFormat.getInstance(new Locale("zh", "CN"));
    ...
    public static String object2json(Object obj) {
        ...
        if (obj == null) {
            json.append("\"\"");
        	 ...
        	 json.append("\"").append(string2json(format((BigDecimal)obj))).append("\"");
        }else if(obj instanceof Date){
        	json.append("\"").append(string2json(date2StrClearDhms((Date)obj))).append("\"");
        }
