...
public class FileUploadUtil {
	...
	public static boolean copyFileNoOverWrite(String oldfile, String newfilepath, String newfile) {
	...
	public static boolean copyFileNoOverWrite(String oldfile, String newfile) {
		if (FileUtil.checkFileExists(oldfile) && !FileUtil.checkFileExists(newfile)) { // 文件存在时
		...
		try {
			...
			for (int i = 0; i < listFiles.length; i++) {
				...
				if (fileSource.isDirectory()) {
					...
					copyFolder(fileSource.getAbsolutePath() + "/", target + "/" + fileSource.getName() + "/");
				} else {
					copyFile(fileSource.getAbsolutePath(), target + "/" + fileSource.getName());
				}
			}
	...
	public static boolean moveFile(String oldPath, String newFolderPath, String fileName) {
	...
	public static String getFileType(String name) {
		String type = "";
		if (!StringUtil.isEmpty(name) && !StringUtil.null2Str(name).endsWith(".")
