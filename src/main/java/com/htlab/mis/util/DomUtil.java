...
public class DomUtil {
	...
	public static boolean validateXml(InputStream document, String file) {
		...
		if (schemaMap.containsKey(file)) {
			...
			Source schemaSource = new StreamSource(ClassLoader.getSystemResourceAsStream(file));
			try {
	 ...
	 * @return
	 */
	public static Document addElementToDocument(Document doc, String elementKey, String value) {
	 ...
	 */
	public static Document addElementToElement(Document doc, String elementKey, String key, String value)
			throws XMLParseException {
		...
		if (nl == null || nl.getLength() < 1) {
			throw new XMLParseException("Node[" + elementKey + "] is not exist.");
		}
	 ...
	 * @throws XMLParseException
	 */
	public static Document addAttributeToElement(Document doc, String elementKey, Map<String, String> keyValue)
			throws XMLParseException {
		...
		Element ele = (Element) doc.getElementsByTagName(elementKey).item(0);
		Iterator<Entry<String, String>> kvIterator = keyValue.entrySet().iterator();
	 ...
	 * @param subElementKey
	 */
	public static void removeElementFromElement(Document doc, String elementKey, String subElementKey) {
		if (doc == null || elementKey == null) {
			throw new NullPointerException();
		}
		NodeList list = doc.getElementsByTagName(elementKey);
	 ...
	 * @param attriKey
	 */
	public static void removeAttriFromElement(Document doc, String elementKey, String attriKey) {
	...
	public static String getElementTextFromDocument(Document doc, String elementKey) {
		if (doc == null || elementKey == null) {
			throw new NullPointerException();
		}
		NodeList list = doc.getElementsByTagName(elementKey);
		Element element = (list != null && list.getLength() >= 1) ? (Element) list.item(0) : null;
		if (element != null) {
	...
	public static Document addElementToElement(Document doc, String elementKey, String key, String value, int index)
			throws XMLParseException {
		if (doc == null || elementKey == null || key == null) {
			throw new NullPointerException();
		}
		...
		Element ele = (Element) doc.getElementsByTagName(elementKey).item(index);
		ele.appendChild(createElement(doc, key, value));
		return doc;
	}
